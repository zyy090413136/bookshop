...
<script>$(document).ready(function(c) {
	$('.alert-close').on('click', function(c){
		window.location="buyDel.php?id="+$('.alert-close').attr("id")+"&url=404.php";
	});	  
});
</script>
</head>
			    ...
			    <?php
					...
					if(!isset($username)){
						...
						if(session_id()!=$sessin_id){
							...
							echo "<a href='Tlogout.php?pre=404.php'> 注销</a>";
							$cdt=true;
						}
					}
				?>
...
<div class="single_top">
	 <div class="container"> 
	  <div class="error-404 text-center">
			<h1>404</h1>
			<p>未找到商品</p>
			<a class="b-home" href="index.php">返回上一页</a>
		  </div>
      </div>
</div>      
<div class="footer">
