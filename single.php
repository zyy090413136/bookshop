...
<script>$(document).ready(function(c) {
	$('.alert-close').on('click', function(c){
		window.location="buyDel.php?id="+$('.alert-close').attr("id")+<?php echo '"&url=single.php?id='.$nnn.'";' ?>
	});	  
});
</script>
			    ...
			    <?php
					...
					if(!isset($username)){
						...
						if(session_id()!=$sessin_id){
							...
							echo "<a href='Tlogout.php?pre=single.php?id=".$nnn."'> 注销</a>";
							$cdt=true;
						}
					}
				?>
	      ...
	      <div class="single_grid">
				<div class="grid images_3_of_2">
						<ul id="etalage">
							<?php
							echo '<li>
								<img class="etalage_thumb_image" src="'.$data['books'][$nnn]["url"].'" class="img-responsive" />
								<img class="etalage_source_image" src="'.$data['books'][$nnn]["url"].'" class="img-responsive" title="" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="'.$data['books'][$nnn]["url"].'" class="img-responsive" />
								<img class="etalage_source_image" src="'.$data['books'][$nnn]["url"].'" class="img-responsive" title="" />
				  ...
				  <div class="desc1 span_3_of_2">
					...
					<?php echo "<h1>".$data['books'][$nnn]["name"]."</h1>" ?>
                    <ul class="price_single">
                      <?php echo '<li class="head"><h2>￥'.$data['books'][$nnn]["much"].'</h2></li>' ?>
					  <?php echo '<li class="head_desc"><a href="#">'.$data['books'][$nnn]["pop"].' 热点投票	</a><img src="images/review.png" alt=""/></li>' ?>
					  <div class="clearfix"></div>
					</ul>
                    <?php echo '<p>'.$data['books'][$nnn]["author"].'</p>' ?>
                    <br>
					<?php echo '<p>'.$data['books'][$nnn]["name"].' '.$data['books'][$nnn]["author"].'</p>' ?>
			         ...
			         <?php echo '<a href="#" class="btn1 btn2 btn-primary1" onclick="loadbuy('.$nnn.')"><span>添加到购物车</span></a> ' ?>
			         <?php echo '<a href="#" class="btn1 btn2 btn-primary1" onclick="loadzan('.$nnn.')"><span>热点投票</span></a>' ?>
				</div>
          	    <div class="clearfix"></div>
          	   </div>
			 <ul class="menu_drop">
