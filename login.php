...
<script>$(document).ready(function(c) {
	$('.alert-close').on('click', function(c){
		window.location="buyDel.php?id="+$('.alert-close').attr("id")+"&url=login.php";
	});	  
});
</script>
</head>
			    ...
			    <?php
					...
					if(!isset($username)){
						...
						if(session_id()!=$sessin_id){
							...
							echo "<a href='Tlogout.php?pre=login.php'> 注销</a>";
							$cdt=true;
						}
					}
				?>
	 ...
	 <div class="container"> 
	    <div class="register">
			  <div class="col-md-6 login-right">
			  	<h3>用户登录</h3>
				<p>如果你拥有一个我们的账号，请在下面登录。</p>
				<p>后台管理账号:admin 密码:admin</p>
				<form method="post" action="Tlogin.php">
				  ...
				  <div>
                    ...
                    <a class="forgot" href="#" style="float:left"><span>忘记密码？</span></a>
                    <input type="submit" value="登录" style="margin:-10px 0 0 338px;width:120px">
                </form>
			   </div>
			    <div class="col-md-6 login-left">
			  	 <h3>用户注册</h3>
				 <p>通过创建一个我们的帐户，您将能够更快地完成结帐，存储多个送货地址，查看和跟踪您的订单，以及更多。</p>
				 <a class="acount-btn" href="register.php">创建一个账号</a>
			   </div>	
			   <div class="clearfix"> </div>
		</div>
     </div>
